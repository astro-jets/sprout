...
const Footer = () => {
    return (
        <footer className="w-full flex items-center justify-center">
            <div className="relative px-2 py-4 w-[98%] z-10 bg-transparent rounded-xl shadow-lg overflow-hidden">
                <div className="container">
                    <div className="-mx-4 flex flex-wrap">
                        ...
                        <LinkGroup header="Courses">
                            <NavLink link="/#" label="Highway Code" />
                            <NavLink link="/#" label="Automatic vehicles" />
                            <NavLink link="/#" label="Manual vehicles" />
                            <NavLink link="/#" label="Abnormal vehices" />
                        </LinkGroup>
...
const LinkGroup = ({ children, header }: { children: JSX.Element[]; header: string }) => {
    return (
        <>
...
const NavLink = ({ link, label }: { link: string; label: string }) => {
    return (
        <li>
            <a
                href={link}
                className="inline-block text-base leading-loose text-[#2c2c2c] hover:text-primary dark:text-dark-6"
            >
                {label}
            </a>
        </li>
